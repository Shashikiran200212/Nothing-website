          ...
          <div className="flex flex-col w-full">
            ...
            >
              ...
              <TextRevealCardDescription>
                <div className="font-mono text-xs sm:text-base md:text-lg lg:text-xl xl:text-2xl mt-3 text-left">
                  <p className="sm:w-full md:w-full lg:w-full xl:w-full">
                    Elite hardware comes together via <br /> Nothing&apos;s TrueLens Engine 2.0.
                  </p>
                </div>
              </TextRevealCardDescription>
            </TextRevealCard>
